...
<ImgDocs
  className="max-w-lg"
  src={audience}
  alt="Audience in Google Auth Platform"
/>
...
<ImgDocs
  className="max-w-lg"
  src={createClient}
  alt="Create OAuth Client in Google Auth Platform"
/>
...
<ImgDocs
  className="max-w-lg"
  src={configureClient}
  alt="Configure OAuth Client in Google Auth Platform"
/>
...
<ImgDocs
  className="max-w-lg"
  src={secretClient}
  alt="Get Client ID & Secret in Google Auth Platform"
/>
...
import vitnodeAuthMethod from '@/assets/guides/sso/vitnode.png';

<ImgDocs src={vitnodeAuthMethod} alt="VitNode Login Methods" />
...
<ImgDocs
  className="max-w-lg"
  src={publish}
  alt="Publish OAuth Client in Google Auth Platform"
/>
