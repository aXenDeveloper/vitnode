...
import { cn } from "cn";
import { Columns2Icon, PlusIcon, SearchIcon, XIcon } from "lucide-react";
...
const CARD_CLASS = cn(
  BLOCK_CATALOG_CARD_CLASS,
  "hover:border-primary/60 hover:bg-accent hover:text-accent-foreground focus-visible:ring-ring transition-colors focus-visible:ring-2 focus-visible:outline-none",
);
