...
export interface EnvVariablesVitNode {
  ...
  core: {
     ...
     *
     * Generated by the install and stored in `core_secrets`, unless
     * `CONTENT_PREVIEW_SECRET` overrides it. Absent only when no content type
     * has `editorial.preview` enabled, i.e. when there is nothing to sign.
     */
