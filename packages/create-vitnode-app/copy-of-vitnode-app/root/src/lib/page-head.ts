 ...
 * `@vitnode/core/tanstack/metadata`: the `"<page> - <site>"` title rule, the
 * decision that a robots directive is stated rather than assumed, and the
 * handling of a `loaderData` that is `undefined` on a route's first pass.
 *
