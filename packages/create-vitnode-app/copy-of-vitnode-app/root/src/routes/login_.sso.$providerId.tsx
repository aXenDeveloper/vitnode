...
import { ErrorActions, RouterLink } from '@vitnode/core/tanstack/layout'
 ...
 *    matches every path beneath it, so a URL no route declares would resolve to
 *    `/login` instead of reaching the not-found boundary. Three leaves, no
 *    shared parent.
 *
