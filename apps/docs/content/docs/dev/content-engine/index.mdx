...
- [`publicApi`](/docs/dev/content-engine/public-api) adds two read-only public
  routes, a strict field allowlist and
  [cache tags](/docs/dev/content-engine/caching)
...
<Cards>
  ...
  />
  <Card
    href="/docs/dev/content-engine/production-hardening"
    title="Production hardening"
    description="What the engine guarantees under concurrency, partial failure and scale - and what it does not."
  />
  <Card
