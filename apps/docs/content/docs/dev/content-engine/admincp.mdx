...
Per-language status, publication, history and delete live in a separate
**Languages** row action, because the language is part of *that* decision rather
than a mode the whole screen is in.
