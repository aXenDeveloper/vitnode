...
| Block       | What it adds                                                       |
| ----------- | ------------------------------------------------------------------ |
| `redirects` | Durable [slug history](/docs/dev/content-engine/slug-history-and-redirects) and automatic 308s |
...
The last one is worth a word: `fallbackTitleField` without `titleField` is a
