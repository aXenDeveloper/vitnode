...
*Unmanaged*, its coverage is left blank because there is no source to measure
against, and *Reindex* is replaced by *Remove documents*. A scoped rebuild of it is
