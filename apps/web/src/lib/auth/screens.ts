import type { ChangePasswordMutationResult } from '@vitnode/core/views/auth/password-reset/change-password-form/schema'
import type { PasswordResetMutationResult } from '@vitnode/core/views/auth/password-reset/form/schema'
import type { SignInMutationResult } from '@vitnode/core/views/auth/sign-in/form/schema'
import type { SignUpMutationResult } from '@vitnode/core/views/auth/sign-up/form/schema'
