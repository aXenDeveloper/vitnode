...
--> statement-breakpoint
ALTER TABLE "core_admin_permissions" ADD CONSTRAINT "core_admin_permissions_role_id_core_roles_id_fk" FOREIGN KEY ("role_id") REFERENCES "public"."core_roles"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "core_moderators_permissions" ADD CONSTRAINT "core_moderators_permissions_role_id_core_roles_id_fk" FOREIGN KEY ("role_id") REFERENCES "public"."core_roles"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "core_users" ADD CONSTRAINT "core_users_role_id_core_roles_id_fk" FOREIGN KEY ("role_id") REFERENCES "public"."core_roles"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "core_admin_permissions_role_id_idx" ON "core_admin_permissions" USING btree ("role_id");--> statement-breakpoint
...
CREATE INDEX "core_moderators_permissions_role_id_idx" ON "core_moderators_permissions" USING btree ("role_id");--> statement-breakpoint
