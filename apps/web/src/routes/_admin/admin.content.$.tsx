 ...
 *
 * ## Ownership moved here in Stage 13
 *
 * Until this file existed, `isTanStackOwnedPath` answered `false` for these URLs
 * and `MigrationLink` sent every content link to the Next.js application. Adding
 * the route flips that automatically, from the route tree, with no list of
 * migrated paths anywhere.
 */
