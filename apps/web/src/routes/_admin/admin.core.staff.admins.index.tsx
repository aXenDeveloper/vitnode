...
/**
 * `/admin/core/staff/admins` - the AdminCP admins list.
 *
 * The twin of `admin.core.staff.moderators.index.tsx`, and deliberately so: the two
 ...
 * (`staff_admins`) and the strings - is derived from that one value inside
 ...
 *
 * The Next.js route at `packages/vitnode/src/routes/admin/core/staff/admins` is
 * still live and unchanged.
 */
export const Route = createFileRoute('/_admin/admin/core/staff/admins/')({
  ...
  staticData: {
    breadcrumb: (
      <AdminStaffBreadcrumbContent LinkComponent={MigrationLink} type="admin" />
    ),
  },
})
