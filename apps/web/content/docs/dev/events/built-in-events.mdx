...
[`editorial.scheduling`](/docs/dev/content-engine/publication-and-editorial#4-scheduled-publishing):
...
[Generated events](/docs/dev/content-engine/services-and-api#event-system).
