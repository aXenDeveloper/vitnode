...
AdminCP is a plugin surface. First [create the plugin](/docs/dev/plugins/create),
then give it an `area: 'admin'` route and a browser-safe navigation declaration.
The host app supplies the panel shell; your plugin supplies the useful bit.
...
export const routes: PluginRouteDefinition[] = [
  // [!code ++:7]
  {
    ...
    id: 'settings',
    namespaces: ['@acme/site-notes.admin'],
...
const AdminSettingsPage = () => {
  const t = useTranslations('@acme/site-notes.admin')
