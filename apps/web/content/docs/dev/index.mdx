...
<Cards>
  ...
  <Card
    ...
    description="Keep MDX concise, searchable, visual, and easy to maintain."
    href="/docs/dev/documentation"
  />
</Cards>
...
4. Create a plugin before adding a product page, API endpoint, content type, or
   dashboard widget.
