...
VitNode supports internationalization (I18n) in email templates through [`use-intl`](https://www.npmjs.com/package/use-intl), the same library every string in the framework renders through.
