...
| **Filling it**   | Drag a block onto the Area, or use **Add widget** on the Area itself - the sidebar then says _For: an area in that zone_, and the Layout section disappears while it is targeted. |
