...
{/* Image prompt: A wireframe of one content zone, top to bottom: a full-width block, then a rounded container labelled "Area · 2 columns" holding two blocks side by side, then another full-width block. A small sidebar on the right shows an "Area" panel with a 1-2-3-4 Columns switch, Alignment and Distribution selects under "LAYOUT", and Gap sliders under "SPACING". Dark UI, blue accents, 1600x900. */}
...
|                  |                                                                                                                                                                                  |
| :--------------- | :------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Adding one**   | The **Layout** section of the **Widgets** catalogue holds a single **Area** entry. It drops an empty Area into the targeted zone.                                                  |
| **Filling it**   | Drag a block onto the Area, or use **Add widget** on the Area itself - the sidebar then says _Adding to an area in that zone_, and the Layout section disappears while it is targeted. |
| **Selecting it** | Click the Area's own shell (not a child) and the sidebar shows **Area properties**: Columns, Alignment and Distribution under **Layout**, then Gap and the space above/below and left/right under **Spacing**. Each control re-lays the page out as you pick it. |
| **Ungroup**      | Removes the Area and leaves its children in the zone, at the position the Area held. Nothing is deleted.                                                                          |
| **Delete area**  | Removes the Area **and** its children. A non-empty Area asks first, and offers _Ungroup, keep widgets_ in the same breath.                                                         |
