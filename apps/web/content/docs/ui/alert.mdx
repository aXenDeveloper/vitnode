...
Every coloured variant shares the same shape - a tinted surface, a matching
border, a coloured icon and a readable title - so they read as one family and
only the hue tells you how worried to be.
