---
title: Radio Group
description: Pick exactly one option from a short list of Zod enum values, as plain radio buttons or as clickable blocks, with a description under each label.
icon: CircleDot
---
